...
run:
	docker-machine ssh default 'docker run -d -p 8888:8888 -e GRANT_SUDO=yes -v /home/docker/notebooks:/home/jovyan/work --user root --name=notebooks bayesjumping/jupyterserver:0.1 start-notebook.sh'
